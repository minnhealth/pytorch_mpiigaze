...
_LANDMARKS: np.ndarray = np.array([
...
_REYE_INDICES: np.ndarray = np.array([36, 39])
_LEYE_INDICES: np.ndarray = np.array([42, 45])
_MOUTH_INDICES: np.ndarray = np.array([48, 54])
...
class FaceModel:
    ...
    LANDMARKS: np.ndarray = dataclasses.field(default_factory=lambda: _LANDMARKS.copy())

    REYE_INDICES: np.ndarray = dataclasses.field(default_factory=lambda: _REYE_INDICES.copy())
    LEYE_INDICES: np.ndarray = dataclasses.field(default_factory=lambda: _LEYE_INDICES.copy())
    MOUTH_INDICES: np.ndarray = dataclasses.field(default_factory=lambda: _MOUTH_INDICES.copy())
